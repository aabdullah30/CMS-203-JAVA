...
public class TwoDimRaggedArrayUtilityTest {
	...
	public void testGetHighestInRowIndex() {
		assertEquals(2,TwoDimRaggedArrayUtility.getHighestInRowIndex(dataSet1,0), 0);
		assertEquals(0,TwoDimRaggedArrayUtility.getHighestInRowIndex(dataSet2,2), 0);
		assertEquals(0,TwoDimRaggedArrayUtility.getHighestInRowIndex(dataSet3,1), 0);
		assertEquals(2,TwoDimRaggedArrayUtility.getHighestInRowIndex(dataSet4,0), 0);
		assertEquals(1,TwoDimRaggedArrayUtility.getHighestInRowIndex(dataSet4,1), 0);
	}
	...
	public void testGetLowestInRowIndex() {
		assertEquals(0,TwoDimRaggedArrayUtility.getLowestInRowIndex(dataSet1,0), 0);
		assertEquals(1,TwoDimRaggedArrayUtility.getLowestInRowIndex(dataSet2,2), 0);
		assertEquals(0,TwoDimRaggedArrayUtility.getLowestInRowIndex(dataSet3,1), 0);
		assertEquals(1,TwoDimRaggedArrayUtility.getLowestInRowIndex(dataSet4,0), 0);
		assertEquals(0,TwoDimRaggedArrayUtility.getLowestInRowIndex(dataSet4,1), 0);
	}
